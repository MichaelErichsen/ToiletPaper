...
public class PriceRecyclerViewAdapter extends RecyclerView.Adapter<PriceRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        ((TextView) root.findViewById(R.id.plItemNo)).setTextSize(fontSize);
        ((TextView) root.findViewById(R.id.plBrand)).setTextSize(fontSize);
        ((TextView) root.findViewById(R.id.plPackagePrice)).setTextSize(fontSize);
        ((TextView) root.findViewById(R.id.plTimeStamp)).setTextSize(fontSize);
